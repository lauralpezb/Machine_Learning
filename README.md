...
En este repositorio encontrarás un ejemplo de como usar modelos de Machine Learning supervisados y no supervisados.

Para los metodos supervisados se requiere el archivo Calidad_Vino.csv y para el de no supervisados se requiere credit-g.csv.
...
```
$git clone https://github.com/lauralpezb/Machine_Learning.git
```
